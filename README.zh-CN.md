...
> [!TIP]
> 寻找开箱即用的研究技能？查看 [**EvoSkills**](https://github.com/EvoScientist/EvoSkills) — 由 **EvoScientist** 引擎驱动，结合可安装技能，端到端研究全流程一步到位。
...
- **[2026 年 3 月 9 日]** 🏆 [ICAIS 2025](https://icais.ai/) AI Scientist Track 6/6 全部中稿 — Best Paper & AI Reviewer's Appraisal Award！[**详情**](https://airaxiv.com/papers/?q=zacharyzhang2022%40gmail.com) 👈
...
> [!TIP]
> 需要 **Python 3.11+**（**< 3.14**）。推荐使用 [**uv**](https://docs.astral.sh/uv/) 或 **conda** 进行依赖管理和虚拟环境管理。
